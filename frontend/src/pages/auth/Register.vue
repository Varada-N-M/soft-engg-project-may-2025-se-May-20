<template>
  <div class="min-h-screen bg-gradient-to-br from-green-400 via-blue-400 to-purple-300 flex items-center justify-center p-4">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div class="absolute top-32 right-16 w-18 h-18 bg-yellow-300 rounded-full opacity-60 animate-bounce" style="animation-delay: 0.3s"></div>
      <div class="absolute bottom-40 left-16 w-16 h-16 bg-orange-300 rounded-full opacity-60 animate-bounce" style="animation-delay: 0.8s"></div>
      <div class="absolute bottom-24 right-12 w-12 h-12 bg-cyan-300 rounded-full opacity-60 animate-bounce" style="animation-delay: 1.2s"></div>
      <div class="absolute top-1/2 left-4 w-10 h-10 bg-red-300 rounded-full opacity-60 animate-bounce" style="animation-delay: 1.8s"></div>
    </div>
    ...
    <div class="w-full max-w-lg">
      ...
      <div class="bg-white rounded-3xl shadow-2xl p-8 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center mb-6 pt-4">
          <div class="w-20 h-20 bg-gradient-to-br from-green-400 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
            <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
            </svg>
          </div>
          <h1 class="text-3xl font-bold text-gray-800 mb-2">Join CoolKids!</h1>
          ...
          <div class="space-y-3">
            <div class="flex items-start">
              ...
              <label for="terms" class="ml-2 text-sm text-gray-700">
                I agree to the 
                <a href="#" class="font-semibold text-green-600 hover:text-green-800 transition-colors">Terms of Service</a>
                and 
                <a href="#" class="font-semibold text-green-600 hover:text-green-800 transition-colors">Privacy Policy</a>
              </label>
            </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            ...
            <router-link to="/login" class="font-semibold text-green-600 hover:text-green-800 transition-colors">
              Sign in here
            </router-link>
          </p>
        </div>
