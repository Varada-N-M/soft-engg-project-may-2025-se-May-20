...
<div class="bg-white rounded-3xl p-8 mb-8 shadow-md">
  <div class="flex flex-wrap items-center justify-between gap-6">
    ...
    <div class="flex space-x-4 min-w-fit font-playfair">
      ...
      >
        ...
        <!-- <div v-if="weeklySkill" class="bg-white rounded-3xl p-8 mb-8 shadow-md font-playfair">
          <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-3 mb-6">
          ...
          <div>
            <div class="flex items-start gap-5">
              <div class="flex-1">
                <h5 class="font-bold text-gray-900 text-lg mb-4">Your This Week's Challenge: {{ weeklySkill.skill_name }}</h5>
                <div class="flex items-center gap-4">
                  <a :href="weeklySkill.video_url">
                  ...
                  <button
                  @click="markSkillAsComplete(weeklySkill.id)"
    ...
    <div class="flex flex-col lg:flex-row gap-6">
      ...
      <div class="w-full lg:w-2/3">
        ...
        <div class="relative w-full overflow-hidden pb-[56.25%] rounded-xl shadow-lg">
          <iframe
            :src="`https://www.youtube.com/embed/${getYouTubeVideoId(weeklySkill.video_url)}`"
      ...
      <!-- Challenge Info & Button (Right Side) -->
  ...
  <div class="bg-white rounded-3xl p-8 mb-8 shadow-md font-playfair">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div 
        v-for="lesson in lifelessons.slice(0, 2)" 
        :key="lesson.id"
...
const fetchweeklySkill = async () => {
  try {
    ...
    const weeklySkills = response.data.skills.filter(skill => skill.skill_type === 'weekly')
