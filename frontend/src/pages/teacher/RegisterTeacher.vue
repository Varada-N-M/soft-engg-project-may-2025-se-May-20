<template>
  <div
      class="min-h-screen bg-gradient-to-br from-blue-400 via-purple-400 to-teal-300 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-2xl">
      ...
      <Card class="bg-white rounded-3xl shadow-2xl p-8 relative overflow-hidden">
        <!-- Decorative top wave -->
        <div class="absolute top-0 left-0 right-0 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-t-3xl"></div>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem v-else-if="schools.length === 0" disabled value="no-schools">No schools available</SelectItem>
                  <SelectItem 
                    v-else
